  ...
  return (
    <div className="container p-4 initial-section d-flex flex-md-row mb-5">
      <div className="col-12 col-md-6 mt-md-5">
        ...
        <p className="">
          ¡Con LaRifamos tienes más oportunidades de ganar porque siempre estás
          a 1 número de lo que más quieres!
        </p>
        <button className="btn-initial d-flex align-items-center">
          <img className="logo-rif" src="./imgs/Icon_Rifamos.svg" alt="" />
          <Link to="/rifas">
