...
function TabMenuInicio({ titulo, descripcion, opciones }) {
    ...
    useEffect(() => {
        ...
        const tabs = document.getElementById("tab-menu").getElementsByClassName("tab-menu-item");
        console.log(tabs);
        for(let tab of tabs) {
            console.log(tab); 
    ...
    return (
        <div className="container mt-2 mt-lg-5">
            ...
            <div id="tab-menu" className="col-12 d-flex justify-content-between tab-menu">
                {opciones.map((opcion) => {
                    return (opcion.titulo === opcionActiva) ?  <div className="tab-menu-item bg-primary"></div> :  
