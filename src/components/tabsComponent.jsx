    ...
    return (
        <div className="container mt-2 mt-lg-5 mb-5">
            ...
            <div className="col-12 d-flex align-content-center align-items-center mt-5 tab-opciones">
                {opciones.map((opcion) => {
                    return <div className="col text-center" onClick={() => setOpcionActiva(opcion)}>
                        <p className="mb-2">{opcion.titulo}</p>
                    </div>;
                })}
            </div>
            <div id="tab-menu" className="col-12 d-flex justify-content-between tab-menu">
                {opciones.map((opcion) => {
                    return (opcion.titulo === opcionActiva.titulo) ?  <div className="tab-menu-item bg-primary" onClick={() => setOpcionActiva(opcion)}></div> :  
                    <div className="tab-menu-item" onClick={() => setOpcionActiva(opcion)}></div>;       
                })}
            </div>
