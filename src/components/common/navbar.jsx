...
function Navbar() {
    ...
    return (
    <>
        {showSideMenu ? <SideMenu onCrossClick={(bool) => setShowSideMenu(bool)} enableScroll={() => enableScroll()}></SideMenu> : <></>}
        <nav id="barraNavegacion" class="container mt-4">
            ...
            <div class="col-3 d-flex align-items-center justify-content-evenly mb-3">
                <button class="menu-btn" onClick={() => {disableScroll(); setShowSideMenu(true)}}><img src="./imgs/ToggleBars.svg" alt="" className="mx-1"/><img src="./imgs/Login.svg" alt=""/></button>
            </div>
        </nav>
        </>
    )
